...
class TBAGetEvents(settings: SettingsActivity): Runnable {
    ...
    override fun run() {
        ...
        val url = URL("https://www.thebluealliance.com/api/v3/events/2023?X-TBA-Auth-Key=INSERT AUTH KEY")
...
//            val currentDate = System.currentTimeMillis() / 1000 //actually gets the current date
        ...
        val runnable = Runnable { settingsActivity.addEventMenu(comingUpEvents) }
